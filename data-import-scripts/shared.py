...
def create_initial_dataset(api, name, dataframe, metadata, description):
    ...
    upload_data(
        api, dataset, dataframe, metadata, description, "Initial import of data at {}".format(datetime.datetime.now())
    )
...
def update_dataset(api, name, dataframe, metadata, description):
    ...
    upload_data(api, dataset, dataframe, metadata, description, "Daily update of data at {}".format(datetime.datetime.now()))
